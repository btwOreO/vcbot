...
from pyJarvis import HNDLR, LOGS, asst, udB, vcClient
from pyJarvis._misc._decorators import compile_pattern
...
from pyJarvis.fns.tools import is_url_ok
from pyJarvis.fns.ytdl import get_videos_link
from pyJarvis._misc import owner_and_sudos, sudoers
from pyJarvis._misc._assistant import in_pattern
...
async def file_download(event, reply, fast_download=True):
    thumb = "https://raw.githubusercontent.com/btwOreO/JarvisMedia/refs/heads/main/img9.jpg"
